/**
 * Integration test: AWS CDK L2 construct → CDKTN (Terraform via awscc provider)
 *
 ...
 * 4. Mix with other Terraform providers (e.g., Datadog)
 * 5. CDKTN synthesizes to pure Terraform HCL (no CloudFormation in output)
 */
